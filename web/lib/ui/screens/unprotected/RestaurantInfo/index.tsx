...
import foodexpressApp from "@/public/assets/images/png/foodexpressApp.png";
...
const RestInfo = () => {
  ...
  const cards = [
    {
      heading: t("grow_with_FoodExpress"),
  ...
  const sideCards = [
    {
      image: foodexpressApp,
      heading: t("how_FoodExpress_works"),
      subHeading: t("how_FoodExpress_works_desc"),
      right: false
    },
    {
  ...
  return (
    <div className='w-screen h-auto'>
      <Heading
        heading={t("reach_more_customers_and_grow_your_business_with_FoodExpress")}
        subHeading={t("partner_with_FoodExpress_to_create_more_sales")}
      />
      <StartingImage image={restaurantBanner} />
      <WhyChoose
        heading={t("why_deliver_with_FoodExpress")}
